...
concentration = float(input("What is the concentration of the protein in mg/mL? "))
molecular_weight = input("What is the name or molecular weight of the protein? ")
if molecular_weight == "Src_WT":
    molecular_weight = 32689.6
elif molecular_weight == "Src_T338I":
    molecular_weight = 33507.5
elif molecular_weight == "Abl_D382N":
    molecular_weight = 33273.1
elif molecular_weight == "Abl_D382N_T334I":
    molecular_weight = 33285.2
elif molecular_weight == "p38_MK14":
    molecular_weight = 41293.2
elif molecular_weight == "CAII_bovine":
    molecular_weight = 29113.7
else:
    molecular_weight = float(molecular_weight)
molarity_input = float(input("At what concentration do you need the protein, 1 uM or 0.5 uM (molarity)? "))
...
print (f"You will need {volume_1} uL of your protein and 13.{buffer_1000} mL of buffer for it to be at {molarity_input} uM.")
